...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <main className="font-montserrat text-lg">
        <h2 className="font-bold text-3xl pb-32 ">
        ...
        <p>
          <span style={{ color: "rgb(68, 68, 68);" }}>
            A sua privacidade é importante para nós. É política do Digital
            Business respeitar a sua privacidade em relação a qualquer
            informação sua que possamos coletar no site{" "}
            <a href="https://digital-business.jaomanoel.com/">
              Digital Business
            </a>
        ...
        <p>
          <span style={{ color: "rgb(68, 68, 68);" }}>
            ...
            informação que o Digital Business oferece no site e com caráter
        ...
        <ul>
          ...
          <li>
            <span style={{ color: "rgb(68, 68, 68);" }}>
              ...
              (softwares) do Digital Business, de seus fornecedores ou
        ...
        <p>
          <span style={{ color: "rgb(68, 68, 68);" }}>
            Esta política é efetiva a partir de&nbsp;14 April 2023 04:52
          </span>
        </p>
      </main>
    </>
